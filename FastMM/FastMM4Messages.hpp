...
// (DO NOT EDIT: machine generated header) 'FastMM4Messages.pas' rev: 23.00 (Win32)
...
#define LeakMessageFooter L"\r\n\r\nNote: This memory leak check is only performed if "\
	L"Delphi is currently running on the same computer. To obtai"\
	L"n a log file containing detail on memory leaks, enable the"\
	L" \"FullDebugMode\" and \"LogMemoryLeakDetailToFile\" condi"\
	L"tional defines. To disable this memory leak check, undefin"\
	L"e \"EnableMemoryLeakReporting\".\r\n\u0000"
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FASTMM4MESSAGES)
